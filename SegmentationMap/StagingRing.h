...
public:
    ...
    bool ExecuteReadback(ID3D11DeviceContext* pContext, ID3D11Texture2D* pSrcColor, ID3D11Texture2D* pSrcStencil, std::vector<uint8_t>& outBGR, std::vector<uint8_t>& outStencil);
    void Release();
};